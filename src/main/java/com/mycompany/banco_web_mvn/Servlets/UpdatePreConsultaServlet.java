 ...
 * @author Marian
 */
@WebServlet(name = "UpdatePreConsultaServlet", urlPatterns = {"/UpdatePreConsultaServlet"})
public class UpdatePreConsultaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if(ClienteDAO.existCliente(dni))
            {
